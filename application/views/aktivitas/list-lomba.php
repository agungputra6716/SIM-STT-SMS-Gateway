...
<head>
  ...
  <title>SIM | List Kegiatan Lomba</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <button class="pull-right btn btn-success" type="button" name="btn_add_aktivitas" id='btn_add_aktivitas'><i class="fa fa-plus"></i>   Tambah Kegiatan Lomba</button>
      </h1>
    </section>
    ...
    <section class="content">
      <div class="box box-solid box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">List Kegiatan Lomba</h3>
        </div>
        <div class="box-body">
              ...
              <?php foreach ($data as $key) {?>
                <tr>
                  ...
                  <td class="btn-group col-md-3">
                    ...
                    <a href="<?php echo base_url("Aktivitas/delete_aktivitas/LOM/".$key->id_aktivitas."")?>" title="Hapus kegiatan" onclick="return confirm('Yakin ingin menghapus data?')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>   Hapus</a>
                    <a href="<?php echo base_url("Aktivitas/send_message/LOM/".$key->id_aktivitas."")?>" title="Kirim Pesan" onclick="return confirm('Yakin ingin mengirim pesan?')" class="btn btn-success"><i class="fa fa-paper-plane-o" aria-hidden="true"></i>   Kirim</a>
                  </td>
                </tr>
                <?php $no++; ?>
              <?php } ?>
      ...
      <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-header" style="background-color: #367fa9;">
            ...
            <h4 id="header" class="modal-title" style="color:white"><i class="fa fa-plus"></i>    Tambah Kegiatan Lomba</h4>
          </div>

          <!--Body-->
          <div class="modal-body">
            <form id="" class="" action="<?php echo base_url('Aktivitas/add_aktivitas/LOM') ?>" method="post">
              <div class="form-group">
                <label for="nama_aktivitas">Nama Kegiatan Lomba</label>
                <input type="text" class="form-control" name="nama_aktivitas" placeholder="Kegiatan" required>
              </div>
              <div class="form-group">
                <label for="detail_aktivitas">Detail Lomba</label>
    ...
    <div class="modal fade" id="modal_edit_aktivitas" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
          ...
          <!--Body-->
          <div class="modal-body">
            <form id="" class="" action="<?php echo base_url('Aktivitas/update_aktivitas/LOM') ?>" method="post">
              ...
              <div class="form-group">
                <label for="tempat_pelaksanaan">Lokasi</label>
                <input type="text" class="form-control" name="tempat_pelaksanaan" id='edit_tempat_pelaksanaan' placeholder="Lokasi Kegiatan" required>
              </div>
              <button class="btn btn-primary btn-block" type="submit" name="button"><i class="fa fa-paper-plane-o"></i>   Kirim</button>
            </form>
          </div>
...
<script>  
  $(document).ready(function() {
    $('#btn_kelola_lomba').addClass('active');
